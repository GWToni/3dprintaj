...
function iskocniProzor(proizvod) {
  ...
  if (proizvod === 'proizvod1') {
    ...
    cijena.innerText = "Cijena: 50€/100KM";
    ...
    cijena.innerText = "Cijena: 30€/60KM";
    ...
    cijena.innerText = "Cijena: 10€/20KM";
    ...
    materijal.innerText = "PLA plastika";
    cijena.innerText = "Cijena: 100€/200KM";
    ...
    materijal.innerText = "ABS plastika";
    cijena.innerText = "Cijena: 15€/30KM";
    ...
    materijal.innerText = "PLA plastika";
    cijena.innerText = "Cijena: 5€/10KM";
  }
